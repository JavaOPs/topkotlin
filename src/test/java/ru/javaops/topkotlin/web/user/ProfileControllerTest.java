...
import ru.javaops.topkotlin.util.UserUtil;
...
import static ru.javaops.topkotlin.web.user.ProfileController.REST_URL;
import static ru.javaops.topkotlin.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
import static ru.javaops.topkotlin.web.user.UserTestData.*;
